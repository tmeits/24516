...
season_growth <- function(sgs, s.year) {
  return(c(sgs[sgs$year == 1964, ]$BG1, sgs[sgs$year == 1964, ]$EG1))
}
...
# Дата перехода через 0C в начале сезона роста
STDAT0 <- 0
# Дата перехода через 5C в начале сезона роста
STDAT5 <- 
# Дата перехода в конце сезона через 5C
FDAT0 <- 
# Дата перехода в конце сезона через 0C 
FDAT5 <- 
# Длительность сезона от 0C до 0C
INTER0 <- 
# Длительность сезона от 5C до 5C
INTER5 <- 

# Дата достижения максимума температуры
MDAT <- 
# Сумма температур больше 0C
SUMT0 <- 
# Сумма температур больше 5C
SUMT5 <- 
