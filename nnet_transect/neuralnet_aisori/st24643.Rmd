...
qplot(year, rwi, data=russ055.rwi, geom = c("point","line","smooth"))
...
net.crn <- neuralnet(CRN ~ Cli_m1 + Cli_m2 + Cli_m3 + Cli_m4 + Cli_m5 + 
    ...
    hidden = c(41), rep = 1, linear.output = TRUE, threshold = 0.01, stepmax = 100000)
...
plot(train_out2[,1], net.results$net.result)
lines(train_out2[,1], net.results$net.result)
lines(train_out2[,1], train.sample[, 13])
lines(train_out2[,1], train.sample[, 13])
