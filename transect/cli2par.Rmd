...
```{r calculate_transect}
par.alatai <- cli2par(paste0(mm_path, "/cli/altai/"), altai.files[3], info = TRUE)
par.lena <- cli2par(paste0(mm_path, "/cli/lena/"), lena.files, info = TRUE)
par.north <- cli2par(paste0(mm_path, "/cli/north/"), north.files[5], info = TRUE)
