...
#library(xlsx)
#install.packages('WriteXLS', dependencies=TRUE, repos='http://cran.rstudio.com/')
#write.xlsx(Minusinsk.cli, paste0(mm_path, "/Minusinsk.cli.xlsx"))
require(WriteXLS)
library(WriteXLS)
x <- list(sheet_a = data.frame(a=letters), sheet_b = data.frame(b = LETTERS))
WriteXLS(x, paste0(mm_path, "/test.xlsx"), names(x))
...
openxlsx::write.xlsx(l, file = "Z:/home/larisa/Dropbox/24516/transect/datasets.xlsx")
